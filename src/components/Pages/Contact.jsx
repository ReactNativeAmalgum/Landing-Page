            ...
            <div className="container">
                ...
                >
                    ...
                    <h2 className="section__heading--title">
                        Looking for to buy a Land?
                    </h2>
                </div>
                <div className="contact__property--inner d-flex">
                    <div
                        className="contact__property--content aos-init aos-animate"
                        data-aos="fade-up"
                        data-aos-duration={1200}
                        data-aos-delay={150}
                    >
                        <p className="contact__property--desc">
                            Browse our property listing and find your best With over 1 million+
                            homes for sale available on the website you with a house you will want
                            to call home. and{" "}
                        </p>
                        <ul className="contact__property--info">
                            <li className="contact__property--info__text">
                                <svg
                                    width={15}
                                    height={11}
                                    viewBox="0 0 15 11"
                        ...
                        <div className="contact__property--thumb">
                            <img src={propertytumb} alt="img" />
                        </div>
                    </div>
                    <div
                        className="contact__property--form aos-init aos-animate"
                        data-aos="fade-up"
                        data-aos-duration={1200}
                        data-aos-delay={200}
                    >
                        <form action="#">
                            <h3 className="contact__property--form__title">Contact Us</h3>
                            <div className="contact__property--form__inner">
                                <div className="contact__property--form__input">
                                ...
                                <button className="contact__property--btn solid__btn" type="submit">
                                    Send Messege
                                </button>
                            </div>
                        </form>
