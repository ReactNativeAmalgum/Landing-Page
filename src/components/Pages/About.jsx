...
import author from '../../assets/img/Propery/properties-author.png'
import abouttumb from '../../assets/img/other/about-thumb3.png'
export default function About() {
    return (
        <section className="about__section section--padding">
            <div className="container-fluid p-0">
                <div className="about__inner style2 d-flex align-items-center">
                    <div
                        className="about__thumbnail--slider position-relative aos-init aos-animate"
                        data-aos="fade-up"
                        data-aos-duration={1200}
                        data-aos-delay={100}
                    >
                        <img src={abouttumb} alt='abouttumb' />
                    </div>
                    <div
                        className="about__content--style aos-init aos-animate"
                        data-aos="fade-up"
                        data-aos-duration={1200}
                        data-aos-delay={150}
                    >
                        ...
                        <div className="about__location--text d-flex mb-10">

                        </div>
                        <p className="about__location--desc">
                        ...
                        <div className="properties__author d-flex align-items-center">
                            ...
                            <div className="properties__author--text">
                                <h3 className="properties__author--name">Leslie Alexander</h3>
                                <a
                                    className="properties__author--email"
                                    href="mailto:example@example.com"
                                >
                                    shahadat.dev1@gmail.com <br />
                                    +91 9993711691
